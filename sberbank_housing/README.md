...
├── README.md
├── requirements.txt
├── run.py                 # CLI: обучение и предсказание
├── data/
...
- '[notebooks/eda.ipynb](notebooks/eda.ipynb)' — загрузка через `src`, разведка целевой, пропусков, районов, корреляций, подготовка фичей.
- `[notebooks/train_model.ipynb](notebooks/train_model.ipynb)' — те же данные и фичи, разбиение по времени, обучение LightGBM, метрики, важность признаков, сохранение модели и сабмита.
...
1. **Загрузка:** train + test + macro, join по дате сделки.
